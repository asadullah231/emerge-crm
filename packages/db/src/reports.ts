/**
 * Agency report aggregates (M14). Read-side computations over the M5 status
 * history + M10 submissions + M12 placements. They live in @emerge/db (not the
 * pure @emerge/reports package) because they use Drizzle; the report catalog,
 * result shape and CSV/schedule helpers stay in @emerge/reports.
 *
...
import type { ReportFilters, ReportKey, ReportTable } from "@emerge/reports";
import {
...
export async function runSubmissionsBySourcer(
  ...
  return {
    ...
    title: REPORT_LABEL.submissionsBySourcer,
...
export async function runTimeInStage(
  ...
  return {
    key: "timeInStage",
    title: REPORT_LABEL.timeInStage,
...
export async function runTimeToFirstSubmission(
  ...
  return {
    ...
    title: REPORT_LABEL.timeToFirstSubmission,
...
export async function runClientHealth(
  ...
  return {
    key: "clientHealth",
    title: REPORT_LABEL.clientHealth,
...
export async function runLeaderboard(
  ...
  return {
    key: "leaderboard",
    title: REPORT_LABEL.leaderboard,
