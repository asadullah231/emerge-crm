...
> Status: **v0.5.0 released** (Milestone 4: Jobs complete).
> Next up: Milestone 5 - Applications: Pipeline, Statuses & Kanban.
...
**[Milestone 5 - Applications: Pipeline, Statuses & Kanban](docs/milestones/m05-applications-pipeline.md)**
(v0.6.0) is next.
